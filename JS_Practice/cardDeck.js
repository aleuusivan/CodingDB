...
function Cards(face, value){
  ...
  const stringifiedDeckOfCards = JSON.stringify(deckOfCards)

  localStorage.setItem('deck',stringifiedDeckOfCards)

  const deckOfCardsFromStorage = localStorage.getItem('deck')